...
if __name__ == '__main__':
  ################################################################################
#
   path_to_load = '/scr2/sens_search/evaluation_results/success_rate/'
   ...
   with open(path_to_load + '20210322_fa_success_rate_wft_noise0.pkl', 'rb') as f:
     ms_total.append(pickle.load(f))

   with open(path_to_load + '20210322_fa_success_rate_wft_noise1.pkl', 'rb') as f:
     ms_total.append(pickle.load(f))

   with open(path_to_load + '20210322_fa_success_rate_wft_noise2.pkl', 'rb') as f:
     ms_total.append(pickle.load(f))

   with open(path_to_load + '20210322_fa_success_rate_wft_noise3.pkl', 'rb') as f:
     ms_total.append(pickle.load(f))

   with open(path_to_load + '20210322_fa_success_rate_wft_noise4.pkl', 'rb') as f:
     ms_total.append(pickle.load(f))
   ...
   with open(path_to_load + '20210322_fbf_success_rate_wft_noise0.pkl', 'rb') as f:
     fbf_total.append(pickle.load(f))

   with open(path_to_load + '20210322_fbf_success_rate_wft_noise1.pkl', 'rb') as f:
     fbf_total.append(pickle.load(f))

   with open(path_to_load + '20210322_fbf_success_rate_wft_noise2.pkl', 'rb') as f:
     fbf_total.append(pickle.load(f))

   with open(path_to_load + '20210322_fbf_success_rate_wft_noise3.pkl', 'rb') as f:
     fbf_total.append(pickle.load(f))

   with open(path_to_load + '20210322_fbf_success_rate_wft_noise4.pkl', 'rb') as f:
     fbf_total.append(pickle.load(f))  
   ...
   plt.tight_layout()
   #plt.savefig(path_to_load + 'success_rate.png')
   # plt.show()   
   #plt.tight_layout()
   plt.savefig(path_to_load + 'success_rate.png')
   #plt.show()
# ########################################################################
   path_to_load = "/scr2/sens_search/evaluation_results/perception_accuracy/"

   # with open(path_to_load + '20201026_full_position_estimation.pkl', 'rb') as f:
   #   med = pickle.load(f)

   with open(path_to_load + '20210321_full_position_estimation_wft_noise4.pkl', 'rb') as f: #'20210318_full_position_estimation_wft_noise.pkl', 'rb') as f:
     mwored = pickle.load(f)

   # with open(path_to_load + '20201028_framebyframe_position_estimation.pkl', 'rb') as f:
   #   fbfed = pickle.load(f)
   
   with open(path_to_load + '20210322_fbf_position_estimation_wft_noise.pkl', 'rb') as f:
     fbfwored = pickle.load(f)
   ...
   # print(type(fbfed))
   # print(fbfed)
   bp0 = plt.boxplot(fbfwored, positions = [1, 3, 5, 7, 9, 11], widths = 0.6, patch_artist = True, showfliers=False)
   ...
   # print(type(mwored))
   # print(mwored)
   # bp1 = plt.boxplot(fbfed, positions = [2, 6, 10, 14, 18, 22], widths = 0.6, patch_artist = True, showfliers=False)
   ...
   # second boxplot pair
   bp2 = plt.boxplot(mwored, positions = [2, 4, 6, 8, 10, 12], widths = 0.6, patch_artist = True, showfliers=False)
   for patch in bp2['boxes']:
     patch.set(facecolor='lightblue') 

   # bp3 = plt.boxplot(med, positions = [4, 8, 12, 16, 20, 24], widths = 0.6, patch_artist = True, showfliers=False)
   # for patch in bp3['boxes']:
   #   patch.set(facecolor='royalblue')

   # print(np.mean(med[-1]))
   # print(np.mean(med[0]))
   print(np.mean(mwored[-1]))
   print(np.mean(mwored[0]))
   # setBoxColors(bp)
   ...
   #hB, = plot([1,1],'magenta')
   hG, = plot([1,1],'lightblue')
   #hR, = plot([1,1],'royalblue')
   hT, = plot([1,1], 'pink')
   legend((hT, hG),('Frame-by-Frame','Full Approach'))
   ...
   tight_layout()
   savefig(path_to_load + 'position_estimation.png')
   # show()

# #####################################################################################
   path_to_load = "/scr2/sens_search/evaluation_results/full_task/"

   with open(path_to_load + '20210322_w_ft_sensor_noise_position_only1.pkl', 'rb') as f: #'20210319_w_ft_sensor_noise_position_only.pkl', 'rb') as f:
     sc_failure = pickle.load(f)

   with open(path_to_load + '20201117_failure_only_stepcounts00.pkl', 'rb') as f:
     sc_baseline = pickle.load(f)

   with open(path_to_load + '20210321_w_ft_sensor_noise_position_type1.pkl', 'rb') as f:
   ...
   plt.savefig(path_to_load + 'full_task_cdf.png', bbox_extra_artists=(lgd,txt,), bbox_inches='tight')
   #plt.show()
